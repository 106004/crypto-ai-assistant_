...
def _build_prompt(message: str, candidates: list[dict[str, object]] | None = None) -> str:
    return (
        ...
        "You may understand any cryptocurrency name.\n"
        "If the user makes an English typo, repeated-letter typo, transposed-letter typo, or other minor typing mistake, infer the intended coin when it is clear.\n"
        "Only output a standard English ticker symbol for a real cryptocurrency that actually exists in the world, or null.\n"
        "Do not invent a ticker for a coin that does not exist.\n"
